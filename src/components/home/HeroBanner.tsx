                    ...
                    */}
                    <div className="pointer-events-none absolute inset-0 flex items-start justify-center pt-6 text-center sm:pt-7 md:items-center md:justify-start md:pt-0 md:text-left">
                      <div className="flex w-full max-w-[85%] flex-col items-center gap-0 px-6 sm:px-10 md:w-auto md:max-w-md md:items-start md:gap-3 md:px-16">
                        ...
                        {headline && (
                          <h2 className="mt-2 line-clamp-2 whitespace-pre-line text-2xl font-bold leading-tight text-neutral-900 md:mt-0 md:text-4xl md:leading-snug">
                            {headline}
                          </h2>
                        )}
                        {subtext && (
                          <p className="mt-1 whitespace-pre-line text-xs leading-none text-amber-700 md:mt-0 md:text-base md:leading-relaxed md:text-neutral-600">
                            {subtext}
                          </p>
                        )}
