...
export const CURATED_PANELS: CuratedPanelDef[] = [
  ...
  { title: "Small Dog Favorites",      bgClass: "bg-rose-100",    handle: "small-dog-favorites",    imageUrl: smallDogFavorites },
  { title: "Squeaky Toys",             bgClass: "bg-emerald-100", handle: "squeaky-toys",           imageUrl: squeakyFavorites },
