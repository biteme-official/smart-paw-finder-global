...
export function InstagramReels() {
  ...
  return (
    <section className="md:mt-10 md:pb-4">
      <div className="max-w-7xl mx-auto px-4 mb-8 md:mb-6">
        <h2 className="text-base font-bold text-foreground text-center md:text-xl">Loved by the Community 🐾</h2>
      </div>
