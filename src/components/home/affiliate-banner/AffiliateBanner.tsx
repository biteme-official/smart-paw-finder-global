...
export function AffiliateBanner() {
  return (
    <section className="mt-4 md:mt-6 px-4">
      <Link
        to="/affiliate"
        className="group flex items-center gap-3 md:gap-4 rounded-2xl bg-orange-500 px-4 py-3 md:px-6 md:py-5 text-white shadow-sm transition-all hover:bg-orange-600 hover:shadow-md"
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="mt-1 block text-[15px] md:text-lg font-extrabold leading-snug">
            Love BITE ME? Earn With Us! 🐾
          </span>
          {/* Mobile: compact single-line CTA */}
          <span className="mt-1 flex sm:hidden items-center gap-1 text-xs font-bold leading-snug text-white">
            Earn 10% commission <ArrowRight className="h-3.5 w-3.5" />
          </span>
        ...
        <span className="sm:hidden flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/15">
