...
const server = http.createServer(async (req, res) => {
  ...
  if (section === 'dashboard') {
    ...
    res.end(JSON.stringify({
      ...
      topProducts: [
        { title: '[로컬Mock] 상품 A', quantity: ri(24), revenue: r(2399.76) },
        { title: '[로컬Mock] 상품 B', quantity: ri(18), revenue: r(1799.82) },
        { title: '[로컬Mock] 상품 C', quantity: ri(12), revenue: r(839.88) },
        { title: '[로컬Mock] 상품 D', quantity: ri(9), revenue: r(539.91) },
        { title: '[로컬Mock] 상품 E', quantity: ri(6), revenue: r(179.94) },
      ],
      countryOrders: [
      ...
      lowStock: [
        { title: '[로컬Mock] 상품 B', variant: 'Black M', quantity: 2 },
        { title: '[로컬Mock] 상품 A', variant: 'Blue', quantity: 3 },
      ],
      currency: 'USD',
      brandSales: [
        { brand: '[로컬Mock] 브랜드 A', quantity: ri(48), revenue: r(4799.52) },
        { brand: '[로컬Mock] 브랜드 B', quantity: ri(24), revenue: r(839.88) },
        { brand: '[로컬Mock] 브랜드 C', quantity: ri(17), revenue: r(191.83) },
      ],
      countryRevenue: [
